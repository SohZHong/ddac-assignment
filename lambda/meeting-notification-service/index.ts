...
interface MeetingLinkRequest {
    ...
    room_id: string;
    meeting_url?: string;
    notification_type?: 'meeting_link' | 'meeting_reminder';
}
...
export const handler: APIGatewayProxyHandler = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
    ...
    try {
        ...
        const request: MeetingLinkRequest = body;
...
async function sendMeetingLinkNotification(data: MeetingLinkRequest): Promise<MeetingLinkResponse> {
    try {
...
function formatEmailMessage(data: MeetingLinkRequest): string {
