...
import { ArrowLeft, Megaphone, Save } from 'lucide-vue-next';
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-muted-foreground">Launch a new health awareness campaign</p>
                    </div>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription> Provide the essential details for your health campaign </CardDescription>
                    </CardHeader>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription> Define your target audience and campaign budget </CardDescription>
                    </CardHeader>
                    <CardContent class="space-y-4">
                        <div class="grid gap-4 md:grid-cols-2">
                            <div class="space-y-2">
